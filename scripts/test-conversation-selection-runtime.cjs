...
set('history',history);set('workspaces',[workspace]);set('providerFilter','All');set('searchQuery','');set('visibleCount',24);set('navigationMode','chats');
...
set('searchQuery','Chat 199');set('visibleCount',24);
