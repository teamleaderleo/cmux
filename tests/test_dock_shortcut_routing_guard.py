...
def explicitly_gated_actions() -> set[str]:
    ...
    # Pane resizing maps its direction to one local action before entering
    # the shared gate. Scope the audit to that handler and require the gate
    # to consume the mapped action; unrelated resize declarations do not count.
