...
// Mux protocol 12; IR SHA-256 d1904d26efcb80e90893f6e3d5092225fd15df14afb79c7188734de6d583824c.
...
type GuestURLAcknowledgeResult struct {
	Accepted bool `json:"accepted"`
}

func (value *GuestURLAcknowledgeResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode GuestURLAcknowledgeResult: expected object")
	}
	var fields struct {
		Accepted *bool `json:"accepted"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode GuestURLAcknowledgeResult: %w", err)
	}
	type wire GuestURLAcknowledgeResult
	var decoded wire
	if fields.Accepted == nil {
		return fmt.Errorf("decode GuestURLAcknowledgeResult: required field accepted is missing or null")
	}
	decoded.Accepted = *fields.Accepted
	*value = GuestURLAcknowledgeResult(decoded)
	return nil
}

type GuestURLClaimResult struct {
	Claimed bool `json:"claimed"`
}

func (value *GuestURLClaimResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode GuestURLClaimResult: expected object")
	}
	var fields struct {
		Claimed *bool `json:"claimed"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode GuestURLClaimResult: %w", err)
	}
	type wire GuestURLClaimResult
	var decoded wire
	if fields.Claimed == nil {
		return fmt.Errorf("decode GuestURLClaimResult: required field claimed is missing or null")
	}
	decoded.Claimed = *fields.Claimed
	*value = GuestURLClaimResult(decoded)
	return nil
}

type GuestURLOpenResult struct {
	Opened bool `json:"opened"`
}

func (value *GuestURLOpenResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode GuestURLOpenResult: expected object")
	}
	var fields struct {
		Opened *bool `json:"opened"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode GuestURLOpenResult: %w", err)
	}
	type wire GuestURLOpenResult
	var decoded wire
	if fields.Opened == nil {
		return fmt.Errorf("decode GuestURLOpenResult: required field opened is missing or null")
	}
	decoded.Opened = *fields.Opened
	*value = GuestURLOpenResult(decoded)
	return nil
}

type GuestURLSubscribeResult struct {
	URLOpenReady bool `json:"url_open_ready"`
}

func (value *GuestURLSubscribeResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode GuestURLSubscribeResult: expected object")
	}
	var fields struct {
		URLOpenReady *bool `json:"url_open_ready"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode GuestURLSubscribeResult: %w", err)
	}
	type wire GuestURLSubscribeResult
	var decoded wire
	if fields.URLOpenReady == nil {
		return fmt.Errorf("decode GuestURLSubscribeResult: required field url_open_ready is missing or null")
	}
	decoded.URLOpenReady = *fields.URLOpenReady
	*value = GuestURLSubscribeResult(decoded)
	return nil
}
...
type MachineListeningTcpResult struct {
	Stdout string `json:"stdout"`
}

func (value *MachineListeningTcpResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode MachineListeningTcpResult: expected object")
	}
	var fields struct {
		Stdout *string `json:"stdout"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode MachineListeningTcpResult: %w", err)
	}
	type wire MachineListeningTcpResult
	var decoded wire
	if fields.Stdout == nil {
		return fmt.Errorf("decode MachineListeningTcpResult: required field stdout is missing or null")
	}
	decoded.Stdout = *fields.Stdout
	*value = MachineListeningTcpResult(decoded)
	return nil
}

type MachineUsage struct {
	APIEquivalentUsd float64                  `json:"api_equivalent_usd"`
	AsOf             RequiredNullable[string] `json:"-"`
	PeriodDays       uint32                   `json:"period_days"`
	TotalTokens      uint64                   `json:"total_tokens"`
	VmID             string                   `json:"vm_id"`
}

func (value MachineUsage) MarshalJSON() ([]byte, error) {
	type wire MachineUsage
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.AsOf.IsSet() {
		return nil, fmt.Errorf("encode MachineUsage: required nullable field as_of is missing")
	}
	if value.AsOf.IsNull() {
		object["as_of"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.AsOf.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode MachineUsage.AsOf: %w", err)
		}
		object["as_of"] = encodedField
	}
	return json.Marshal(object)
}

func (value *MachineUsage) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode MachineUsage: expected object")
	}
	var fields struct {
		APIEquivalentUsd *float64                 `json:"api_equivalent_usd"`
		AsOf             RequiredNullable[string] `json:"as_of"`
		PeriodDays       *uint32                  `json:"period_days"`
		TotalTokens      *uint64                  `json:"total_tokens"`
		VmID             *string                  `json:"vm_id"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode MachineUsage: %w", err)
	}
	type wire MachineUsage
	var decoded wire
	if fields.APIEquivalentUsd == nil {
		return fmt.Errorf("decode MachineUsage: required field api_equivalent_usd is missing or null")
	}
	decoded.APIEquivalentUsd = *fields.APIEquivalentUsd
	if !fields.AsOf.IsSet() {
		return fmt.Errorf("decode MachineUsage: required field as_of is missing")
	}
	decoded.AsOf = fields.AsOf
	if fields.PeriodDays == nil {
		return fmt.Errorf("decode MachineUsage: required field period_days is missing or null")
	}
	decoded.PeriodDays = *fields.PeriodDays
	if fields.TotalTokens == nil {
		return fmt.Errorf("decode MachineUsage: required field total_tokens is missing or null")
	}
	decoded.TotalTokens = *fields.TotalTokens
	if fields.VmID == nil {
		return fmt.Errorf("decode MachineUsage: required field vm_id is missing or null")
	}
	decoded.VmID = *fields.VmID
	*value = MachineUsage(decoded)
	return nil
}

type MachineUsageResult struct {
	Usage RequiredNullable[MachineUsage] `json:"-"`
}

func (value MachineUsageResult) MarshalJSON() ([]byte, error) {
	type wire MachineUsageResult
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Usage.IsSet() {
		return nil, fmt.Errorf("encode MachineUsageResult: required nullable field usage is missing")
	}
	if value.Usage.IsNull() {
		object["usage"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Usage.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode MachineUsageResult.Usage: %w", err)
		}
...
func (value *MachineUsageResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode MachineUsageResult: expected object")
	}
	var fields struct {
		Usage RequiredNullable[MachineUsage] `json:"usage"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode MachineUsageResult: %w", err)
	}
	type wire MachineUsageResult
	var decoded wire
	if !fields.Usage.IsSet() {
		return fmt.Errorf("decode MachineUsageResult: required field usage is missing")
	}
	decoded.Usage = fields.Usage
	*value = MachineUsageResult(decoded)
	return nil
}
...
type ServerStatsConnections struct {
...
func (value *ServerStatsConnections) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsConnections: expected object")
	}
	var fields struct {
		Accepted *uint64 `json:"accepted"`
		Active   *uint64 `json:"active"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsConnections: %w", err)
	}
	type wire ServerStatsConnections
	var decoded wire
	if fields.Accepted == nil {
		return fmt.Errorf("decode ServerStatsConnections: required field accepted is missing or null")
	}
	decoded.Accepted = *fields.Accepted
	if fields.Active == nil {
		return fmt.Errorf("decode ServerStatsConnections: required field active is missing or null")
	}
	decoded.Active = *fields.Active
	if fields.Limit == nil {
		return fmt.Errorf("decode ServerStatsConnections: required field limit is missing or null")
	}
	decoded.Limit = *fields.Limit
	if fields.Peak == nil {
		return fmt.Errorf("decode ServerStatsConnections: required field peak is missing or null")
	}
	decoded.Peak = *fields.Peak
	if fields.Refused == nil {
		return fmt.Errorf("decode ServerStatsConnections: required field refused is missing or null")
	}
	decoded.Refused = *fields.Refused
	*value = ServerStatsConnections(decoded)
	return nil
}

type ServerStatsHistogram struct {
...
func (value *ServerStatsHistogram) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsHistogram: expected object")
	}
	var fields struct {
		Count *uint64 `json:"count"`
		Max   *uint64 `json:"max"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsHistogram: %w", err)
	}
	type wire ServerStatsHistogram
	var decoded wire
	if fields.Count == nil {
		return fmt.Errorf("decode ServerStatsHistogram: required field count is missing or null")
	}
	decoded.Count = *fields.Count
	if fields.Max == nil {
		return fmt.Errorf("decode ServerStatsHistogram: required field max is missing or null")
	}
	decoded.Max = *fields.Max
	if fields.Mean == nil {
		return fmt.Errorf("decode ServerStatsHistogram: required field mean is missing or null")
	}
	decoded.Mean = *fields.Mean
	if fields.P50 == nil {
		return fmt.Errorf("decode ServerStatsHistogram: required field p50 is missing or null")
	}
	decoded.P50 = *fields.P50
	if fields.P90 == nil {
		return fmt.Errorf("decode ServerStatsHistogram: required field p90 is missing or null")
	}
	decoded.P90 = *fields.P90
	if fields.P99 == nil {
		return fmt.Errorf("decode ServerStatsHistogram: required field p99 is missing or null")
	}
	decoded.P99 = *fields.P99
	*value = ServerStatsHistogram(decoded)
	return nil
}

type ServerStatsJournalWriter struct {
	BatchSize        ServerStatsHistogram   `json:"batch_size"`
	Batches          uint64                 `json:"batches"`
	CommitFailures   uint64                 `json:"commit_failures"`
	CommitLockWaitUs ServerStatsHistogram   `json:"commit_lock_wait_us"`
	CommitUs         ServerStatsHistogram   `json:"commit_us"`
	DeadlineExpiries uint64                 `json:"deadline_expiries"`
	DurableEvents    uint64                 `json:"durable_events"`
	DurableQueued    uint64                 `json:"durable_queued"`
	Phase            ServerStatsWriterPhase `json:"phase"`
	PhaseForUs       uint64                 `json:"phase_for_us"`
	ReceiptWaitUs    ServerStatsHistogram   `json:"receipt_wait_us"`
	TerminalEvents   uint64                 `json:"terminal_events"`
	TerminalQueued   uint64                 `json:"terminal_queued"`
}

func (value *ServerStatsJournalWriter) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsJournalWriter: expected object")
	}
	var fields struct {
		BatchSize        *ServerStatsHistogram   `json:"batch_size"`
		Batches          *uint64                 `json:"batches"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: %w", err)
	}
	type wire ServerStatsJournalWriter
	var decoded wire
	if fields.BatchSize == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field batch_size is missing or null")
	}
	decoded.BatchSize = *fields.BatchSize
	if fields.Batches == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field batches is missing or null")
	}
	decoded.Batches = *fields.Batches
	if fields.CommitFailures == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field commit_failures is missing or null")
	}
	decoded.CommitFailures = *fields.CommitFailures
	if fields.CommitLockWaitUs == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field commit_lock_wait_us is missing or null")
	}
	decoded.CommitLockWaitUs = *fields.CommitLockWaitUs
	if fields.CommitUs == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field commit_us is missing or null")
	}
	decoded.CommitUs = *fields.CommitUs
	if fields.DeadlineExpiries == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field deadline_expiries is missing or null")
	}
	decoded.DeadlineExpiries = *fields.DeadlineExpiries
	if fields.DurableEvents == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field durable_events is missing or null")
	}
	decoded.DurableEvents = *fields.DurableEvents
	if fields.DurableQueued == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field durable_queued is missing or null")
	}
	decoded.DurableQueued = *fields.DurableQueued
	if fields.Phase == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field phase is missing or null")
	}
	decoded.Phase = *fields.Phase
	if fields.PhaseForUs == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field phase_for_us is missing or null")
	}
	decoded.PhaseForUs = *fields.PhaseForUs
	if fields.ReceiptWaitUs == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field receipt_wait_us is missing or null")
	}
	decoded.ReceiptWaitUs = *fields.ReceiptWaitUs
	if fields.TerminalEvents == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field terminal_events is missing or null")
	}
	decoded.TerminalEvents = *fields.TerminalEvents
	if fields.TerminalQueued == nil {
		return fmt.Errorf("decode ServerStatsJournalWriter: required field terminal_queued is missing or null")
	}
	decoded.TerminalQueued = *fields.TerminalQueued
	*value = ServerStatsJournalWriter(decoded)
	return nil
}

type ServerStatsLockHolder struct {
	HeldForUs uint64 `json:"held_for_us"`
	Site      string `json:"site"`
}

func (value *ServerStatsLockHolder) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsLockHolder: expected object")
	}
	var fields struct {
		HeldForUs *uint64 `json:"held_for_us"`
		Site      *string `json:"site"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsLockHolder: %w", err)
	}
	type wire ServerStatsLockHolder
	var decoded wire
	if fields.HeldForUs == nil {
		return fmt.Errorf("decode ServerStatsLockHolder: required field held_for_us is missing or null")
	}
	decoded.HeldForUs = *fields.HeldForUs
	if fields.Site == nil {
		return fmt.Errorf("decode ServerStatsLockHolder: required field site is missing or null")
	}
	decoded.Site = *fields.Site
	*value = ServerStatsLockHolder(decoded)
	return nil
}

type ServerStatsLockSite struct {
	Acquisitions uint64 `json:"acquisitions"`
	HoldMaxUs    uint64 `json:"hold_max_us"`
	HoldTotalUs  uint64 `json:"hold_total_us"`
	Site         string `json:"site"`
}

func (value *ServerStatsLockSite) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsLockSite: expected object")
	}
	var fields struct {
		Acquisitions *uint64 `json:"acquisitions"`
		HoldMaxUs    *uint64 `json:"hold_max_us"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsLockSite: %w", err)
	}
	type wire ServerStatsLockSite
	var decoded wire
	if fields.Acquisitions == nil {
		return fmt.Errorf("decode ServerStatsLockSite: required field acquisitions is missing or null")
	}
	decoded.Acquisitions = *fields.Acquisitions
	if fields.HoldMaxUs == nil {
		return fmt.Errorf("decode ServerStatsLockSite: required field hold_max_us is missing or null")
	}
	decoded.HoldMaxUs = *fields.HoldMaxUs
	if fields.HoldTotalUs == nil {
		return fmt.Errorf("decode ServerStatsLockSite: required field hold_total_us is missing or null")
	}
	decoded.HoldTotalUs = *fields.HoldTotalUs
	if fields.Site == nil {
		return fmt.Errorf("decode ServerStatsLockSite: required field site is missing or null")
	}
	decoded.Site = *fields.Site
	*value = ServerStatsLockSite(decoded)
	return nil
}

type ServerStatsLockStall struct {
	Blocker  RequiredNullable[string] `json:"-"`
	WaitedUs uint64                   `json:"waited_us"`
	Waiter   string                   `json:"waiter"`
}

func (value ServerStatsLockStall) MarshalJSON() ([]byte, error) {
	type wire ServerStatsLockStall
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Blocker.IsSet() {
		return nil, fmt.Errorf("encode ServerStatsLockStall: required nullable field blocker is missing")
	}
	if value.Blocker.IsNull() {
		object["blocker"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Blocker.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ServerStatsLockStall.Blocker: %w", err)
		}
		object["blocker"] = encodedField
	}
	return json.Marshal(object)
}

func (value *ServerStatsLockStall) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsLockStall: expected object")
	}
	var fields struct {
		Blocker  RequiredNullable[string] `json:"blocker"`
		WaitedUs *uint64                  `json:"waited_us"`
		Waiter   *string                  `json:"waiter"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsLockStall: %w", err)
	}
	type wire ServerStatsLockStall
	var decoded wire
	if !fields.Blocker.IsSet() {
		return fmt.Errorf("decode ServerStatsLockStall: required field blocker is missing")
	}
	decoded.Blocker = fields.Blocker
	if fields.WaitedUs == nil {
		return fmt.Errorf("decode ServerStatsLockStall: required field waited_us is missing or null")
	}
	decoded.WaitedUs = *fields.WaitedUs
	if fields.Waiter == nil {
		return fmt.Errorf("decode ServerStatsLockStall: required field waiter is missing or null")
	}
	decoded.Waiter = *fields.Waiter
	*value = ServerStatsLockStall(decoded)
	return nil
}

type ServerStatsRegistryLock struct {
	ContendedAcquisitions uint64                                  `json:"contended_acquisitions"`
	HoldUs                ServerStatsHistogram                    `json:"hold_us"`
	Holder                RequiredNullable[ServerStatsLockHolder] `json:"-"`
	LastStall             RequiredNullable[ServerStatsLockStall]  `json:"-"`
	Stalls                uint64                                  `json:"stalls"`
	TopSites              []ServerStatsLockSite                   `json:"top_sites"`
	WaitUs                ServerStatsHistogram                    `json:"wait_us"`
}

func (value ServerStatsRegistryLock) MarshalJSON() ([]byte, error) {
	type wire ServerStatsRegistryLock
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Holder.IsSet() {
		return nil, fmt.Errorf("encode ServerStatsRegistryLock: required nullable field holder is missing")
	}
	if value.Holder.IsNull() {
		object["holder"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.Holder.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ServerStatsRegistryLock.Holder: %w", err)
		}
		object["holder"] = encodedField
	}
	if !value.LastStall.IsSet() {
		return nil, fmt.Errorf("encode ServerStatsRegistryLock: required nullable field last_stall is missing")
	}
	if value.LastStall.IsNull() {
		object["last_stall"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.LastStall.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ServerStatsRegistryLock.LastStall: %w", err)
		}
		object["last_stall"] = encodedField
	}
	return json.Marshal(object)
}

func (value *ServerStatsRegistryLock) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsRegistryLock: expected object")
	}
	var fields struct {
		ContendedAcquisitions *uint64                                 `json:"contended_acquisitions"`
		HoldUs                *ServerStatsHistogram                   `json:"hold_us"`
		Holder                RequiredNullable[ServerStatsLockHolder] `json:"holder"`
		LastStall             RequiredNullable[ServerStatsLockStall]  `json:"last_stall"`
		Stalls                *uint64                                 `json:"stalls"`
		TopSites              *[]ServerStatsLockSite                  `json:"top_sites"`
		WaitUs                *ServerStatsHistogram                   `json:"wait_us"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsRegistryLock: %w", err)
	}
	type wire ServerStatsRegistryLock
	var decoded wire
	if fields.ContendedAcquisitions == nil {
		return fmt.Errorf("decode ServerStatsRegistryLock: required field contended_acquisitions is missing or null")
	}
	decoded.ContendedAcquisitions = *fields.ContendedAcquisitions
	if fields.HoldUs == nil {
		return fmt.Errorf("decode ServerStatsRegistryLock: required field hold_us is missing or null")
	}
	decoded.HoldUs = *fields.HoldUs
	if !fields.Holder.IsSet() {
		return fmt.Errorf("decode ServerStatsRegistryLock: required field holder is missing")
	}
	decoded.Holder = fields.Holder
	if !fields.LastStall.IsSet() {
		return fmt.Errorf("decode ServerStatsRegistryLock: required field last_stall is missing")
	}
	decoded.LastStall = fields.LastStall
	if fields.Stalls == nil {
		return fmt.Errorf("decode ServerStatsRegistryLock: required field stalls is missing or null")
	}
	decoded.Stalls = *fields.Stalls
	if fields.TopSites == nil {
		return fmt.Errorf("decode ServerStatsRegistryLock: required field top_sites is missing or null")
	}
	decoded.TopSites = *fields.TopSites
	if fields.WaitUs == nil {
		return fmt.Errorf("decode ServerStatsRegistryLock: required field wait_us is missing or null")
	}
	decoded.WaitUs = *fields.WaitUs
	*value = ServerStatsRegistryLock(decoded)
	return nil
}

type ServerStatsResult struct {
	Connections   ServerStatsConnections                     `json:"connections"`
	JournalWriter RequiredNullable[ServerStatsJournalWriter] `json:"-"`
	RegistryLock  ServerStatsRegistryLock                    `json:"registry_lock"`
	Schema        uint32                                     `json:"schema"`
	UptimeMs      uint64                                     `json:"uptime_ms"`
}

func (value ServerStatsResult) MarshalJSON() ([]byte, error) {
	type wire ServerStatsResult
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.JournalWriter.IsSet() {
		return nil, fmt.Errorf("encode ServerStatsResult: required nullable field journal_writer is missing")
	}
	if value.JournalWriter.IsNull() {
		object["journal_writer"] = json.RawMessage("null")
	} else {
		fieldValue, _ := value.JournalWriter.Get()
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode ServerStatsResult.JournalWriter: %w", err)
		}
		object["journal_writer"] = encodedField
	}
	return json.Marshal(object)
}

func (value *ServerStatsResult) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode ServerStatsResult: expected object")
	}
	var fields struct {
		Connections   *ServerStatsConnections                    `json:"connections"`
		JournalWriter RequiredNullable[ServerStatsJournalWriter] `json:"journal_writer"`
		RegistryLock  *ServerStatsRegistryLock                   `json:"registry_lock"`
		Schema        *uint32                                    `json:"schema"`
		UptimeMs      *uint64                                    `json:"uptime_ms"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode ServerStatsResult: %w", err)
	}
	type wire ServerStatsResult
	var decoded wire
	if fields.Connections == nil {
		return fmt.Errorf("decode ServerStatsResult: required field connections is missing or null")
	}
	decoded.Connections = *fields.Connections
	if !fields.JournalWriter.IsSet() {
		return fmt.Errorf("decode ServerStatsResult: required field journal_writer is missing")
	}
	decoded.JournalWriter = fields.JournalWriter
	if fields.RegistryLock == nil {
		return fmt.Errorf("decode ServerStatsResult: required field registry_lock is missing or null")
	}
	decoded.RegistryLock = *fields.RegistryLock
	if fields.Schema == nil {
		return fmt.Errorf("decode ServerStatsResult: required field schema is missing or null")
	}
	decoded.Schema = *fields.Schema
	if fields.UptimeMs == nil {
		return fmt.Errorf("decode ServerStatsResult: required field uptime_ms is missing or null")
	}
	decoded.UptimeMs = *fields.UptimeMs
	*value = ServerStatsResult(decoded)
	return nil
}

type ServerStatsWriterPhase string

const (
	ServerStatsWriterPhaseIdle        ServerStatsWriterPhase = "idle"
	ServerStatsWriterPhaseWaitingLock ServerStatsWriterPhase = "waiting_lock"
	ServerStatsWriterPhaseCommitting  ServerStatsWriterPhase = "committing"
)

func (value ServerStatsWriterPhase) valid() bool {
	switch value {
	case ServerStatsWriterPhaseIdle, ServerStatsWriterPhaseWaitingLock, ServerStatsWriterPhaseCommitting:
		return true
	default:
		return false
	}
...
func (value ServerStatsWriterPhase) MarshalJSON() ([]byte, error) {
	if !value.valid() {
		return nil, fmt.Errorf("%s has invalid value %v", "ServerStatsWriterPhase", value)
	}
	return json.Marshal(string(value))
}

func (value *ServerStatsWriterPhase) UnmarshalJSON(data []byte) error {
	var decoded string
	if err := json.Unmarshal(data, &decoded); err != nil {
		return err
	}
	candidate := ServerStatsWriterPhase(decoded)
	if !candidate.valid() {
		return fmt.Errorf("%s has invalid value %v", "ServerStatsWriterPhase", decoded)
	}
	*value = candidate
	return nil
}
...
type TerminalColorOverrides struct {
	Bg     RequiredNullable[ColorHex] `json:"-"`
	Cursor RequiredNullable[ColorHex] `json:"-"`
	Fg     RequiredNullable[ColorHex] `json:"-"`
}

func (value TerminalColorOverrides) MarshalJSON() ([]byte, error) {
	type wire TerminalColorOverrides
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Bg.IsSet() {
		return nil, fmt.Errorf("encode TerminalColorOverrides: required nullable field bg is missing")
	}
	if value.Bg.IsNull() {
		object["bg"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode TerminalColorOverrides.Bg: %w", err)
		}
		object["bg"] = encodedField
	}
	if !value.Cursor.IsSet() {
		return nil, fmt.Errorf("encode TerminalColorOverrides: required nullable field cursor is missing")
	}
	if value.Cursor.IsNull() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode TerminalColorOverrides.Cursor: %w", err)
		}
		object["cursor"] = encodedField
	}
	if !value.Fg.IsSet() {
		return nil, fmt.Errorf("encode TerminalColorOverrides: required nullable field fg is missing")
	}
	if value.Fg.IsNull() {
		object["fg"] = json.RawMessage("null")
	} else {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode TerminalColorOverrides.Fg: %w", err)
		}
		object["fg"] = encodedField
	}
	return json.Marshal(object)
...
func (value *TerminalColorOverrides) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode TerminalColorOverrides: expected object")
	}
	var fields struct {
		Bg     RequiredNullable[ColorHex] `json:"bg"`
		Cursor RequiredNullable[ColorHex] `json:"cursor"`
		Fg     RequiredNullable[ColorHex] `json:"fg"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode TerminalColorOverrides: %w", err)
	}
	type wire TerminalColorOverrides
	var decoded wire
	if !fields.Bg.IsSet() {
		return fmt.Errorf("decode TerminalColorOverrides: required field bg is missing")
	}
	decoded.Bg = fields.Bg
	if !fields.Cursor.IsSet() {
		return fmt.Errorf("decode TerminalColorOverrides: required field cursor is missing")
	}
	decoded.Cursor = fields.Cursor
	if !fields.Fg.IsSet() {
		return fmt.Errorf("decode TerminalColorOverrides: required field fg is missing")
	}
	decoded.Fg = fields.Fg
	*value = TerminalColorOverrides(decoded)
	return nil
}
...
type TerminalColors struct {
	...
	Fg          RequiredNullable[ColorHex] `json:"-"`
	Overrides   *TerminalColorOverrides    `json:"overrides,omitempty"`
...
func (value *TerminalColors) UnmarshalJSON(data []byte) error {
	...
	var fields struct {
		...
		Fg          RequiredNullable[ColorHex]                  `json:"fg"`
		Overrides   optionalNonNullJSON[TerminalColorOverrides] `json:"overrides"`
	...
	decoded.Fg = fields.Fg
	if fields.Overrides.null {
		return fmt.Errorf("decode TerminalColors: non-nullable field overrides is null")
	}
	if fields.Overrides.set {
		decoded.Overrides = &fields.Overrides.value
	}
