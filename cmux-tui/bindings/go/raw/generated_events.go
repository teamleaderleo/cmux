...
func (value *ColorsChangedEvent) UnmarshalJSON(data []byte) error {
	...
	if fields.Overrides.null {
		return fmt.Errorf("decode ColorsChangedEvent: non-nullable field overrides is null")
	}
...
// MachineUsageChangedEvent is emitted by protocol v12.
type MachineUsageChangedEvent struct {
	Usage RequiredNullable[MachineUsage] `json:"-"`
}

func (value MachineUsageChangedEvent) MarshalJSON() ([]byte, error) {
	type wire MachineUsageChangedEvent
	encoded, err := json.Marshal(wire(value))
	if err != nil {
		return nil, err
	}
	...
	if !value.Usage.IsSet() {
		return nil, fmt.Errorf("encode MachineUsageChangedEvent: required nullable field usage is missing")
	}
	if value.Usage.IsNull() {
		...
		encodedField, err := json.Marshal(fieldValue)
		if err != nil {
			return nil, fmt.Errorf("encode MachineUsageChangedEvent.Usage: %w", err)
		}
...
func (value *MachineUsageChangedEvent) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode MachineUsageChangedEvent: expected object")
	}
	var fields struct {
		Usage RequiredNullable[MachineUsage] `json:"usage"`
	}
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode MachineUsageChangedEvent: %w", err)
	}
	type wire MachineUsageChangedEvent
	var decoded wire
	if !fields.Usage.IsSet() {
		return fmt.Errorf("decode MachineUsageChangedEvent: required field usage is missing")
	}
	decoded.Usage = fields.Usage
	*value = MachineUsageChangedEvent(decoded)
	return nil
}

func (MachineUsageChangedEvent) EventName() string { return "machine-usage-changed" }
func (MachineUsageChangedEvent) isDeltaEvent()     {}
func (MachineUsageChangedEvent) isSubscribeEvent() {}
...
// URLOpenEvent is emitted by protocol v12.
type URLOpenEvent struct {
	RequestID  string `json:"request_id"`
	TerminalID string `json:"terminal_id"`
	URL        string `json:"url"`
}

func (value *URLOpenEvent) UnmarshalJSON(data []byte) error {
	if !isJSONObject(data) {
		return fmt.Errorf("decode URLOpenEvent: expected object")
	}
	var fields struct {
		Event      *string `json:"event"`
		RequestID  *string `json:"request_id"`
	...
	if err := json.Unmarshal(data, &fields); err != nil {
		return fmt.Errorf("decode URLOpenEvent: %w", err)
	}
	if fields.Event == nil {
		return fmt.Errorf("decode URLOpenEvent: required field event is missing or null")
	}
	if *fields.Event != "url-open" {
		return fmt.Errorf("decode URLOpenEvent.event: invalid value %q", *fields.Event)
	}
	type wire URLOpenEvent
	var decoded wire
	if fields.RequestID == nil {
		return fmt.Errorf("decode URLOpenEvent: required field request_id is missing or null")
	}
	decoded.RequestID = *fields.RequestID
	if fields.TerminalID == nil {
		return fmt.Errorf("decode URLOpenEvent: required field terminal_id is missing or null")
	}
	decoded.TerminalID = *fields.TerminalID
	if fields.URL == nil {
		return fmt.Errorf("decode URLOpenEvent: required field url is missing or null")
	}
	decoded.URL = *fields.URL
	*value = URLOpenEvent(decoded)
	return nil
}

func (URLOpenEvent) EventName() string { return "url-open" }
...
func parseEvent(raw map[string]any) Event {
	...
	case "machine-usage-changed":
		var event MachineUsageChangedEvent
		if decodeEvent(raw, &event) {
			return event
		}
	case "notification":
